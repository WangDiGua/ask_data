    ...
    CoreTableDefinition(
        ...
        fields=(
            ...
            CoreFieldDefinition(
                ...
                ("姓名", "名字"),
                "t_bsdt_jzgygcg",
                ("roster", "detail", "record", "attribute"),
            ),
            CoreFieldDefinition(
                "year",
                "年份",
            ...
            CoreFieldDefinition(
                ...
                ("职称",),
                "t_bsdt_jzgygcg",
                ("aggregate", "roster", "detail", "attribute"),
            ),
            CoreFieldDefinition(
                "position_name",
                "行政职务",
            ...
            CoreFieldDefinition(
                ...
                "t_bsdt_jzgygcg",
                sample_values=("美国", "日本", "德国", "英国", "泰国", "韩国", "中国-澳门"),
    ...
    CoreTableDefinition(
        ...
        fields=(
            ...
            CoreFieldDefinition(
                ...
                ("国家", "地区", "国家地区"),
                "t_gjc_lfzj",
                sample_values=("美国", "德国", "巴西", "英国", "澳大利亚", "中国", "日本", "韩国"),
            ),
            CoreFieldDefinition(
                "gender_name",
                "性别",
            ...
            CoreFieldDefinition(
                ...
                ("来访目的", "访问目的"),
                "t_gjc_lfzj",
                sample_values=("学术访问", "讲座教学", "合作研究", "学术会议", "培训进修"),
            ),
            CoreFieldDefinition(
                "start_date",
                "来访开始时间",
